...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-fw fa-sort-amount-down-alt"></i> Adicionar pagamento
        </h1>
    ...
    <form id="formOrder" class="needs-validation" method="POST" action="{{ route('bills-pay.store') }}" onsubmit="checkChartAccounts()" novalidate>
        @csrf
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="col-lg-12 col-md-12 mb-3">
                        <textarea class="form-control" name="note" id="exampleFormControlNoteBillsPay" rows="5"></textarea>
                    </div>
                </div>
