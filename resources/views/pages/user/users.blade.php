...
{{--                    <thead class="thead-light">--}}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$user->level}}</td>
                            <td class="pt-2">
{{--                                <a href="{{ route('user.show', ['user' => $user->id]) }}"><button class="btn btn-info btn-sm py-0 px-1 mt-1" data-toggle="modal" data-placement="top" title="Ver" data-target="#modalUserDetail"><i class="far fa-eye"></i></button></a>--}}
