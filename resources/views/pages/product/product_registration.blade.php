                ...
                <div class="form-row">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class=""><input type="text" class="form-control bg-primary font-weight-bold text-white" name="sales_value_product_used" id="salesValueProductUsed" placeholder="0,00"></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
